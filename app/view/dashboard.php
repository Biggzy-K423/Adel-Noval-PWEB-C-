      ...
      <div class="container">
        <nav>
          <ul>
            ...
            <li><a href="v_index.php" class="logout">
          ...
          <section class="attendance">
            <div class="attendance-list">
              <div class="flex-between">
                <h1>List Konsumen</h1>
                <form action="home\routes.php?route=tambah" method="post">
                ...
                <tbody>
                  ...
                  if (mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td><img src = '/home/gambar/". $row["Bukti_tf"]. "' alt = 'Bukti_tf' width = '50px' height = '50px'</td>";

                        echo "</td>"; 

                        echo "<td><button onclick=\"window.location.href='routes.php?route=edit&ID_Pelanggan=" . $row['ID_Pelanggan'] . "'\">Edit</button></td>";
                       echo "<td><a href='routes.php?route=hapus&ID_Pelanggan=".$row['ID_Pelanggan']."&proses=remove'><button>Hapus</button></a></td>";
